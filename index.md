...
- [`RMreliability()`](https://pgmj.github.io/easyRasch2/reference/RMreliability.md) +
  ...
  — Cronbach’s α, PSI, empirical reliability, and
  Bignardi-Kievit-Bürkner RMU from plausible values
...
Claude to “transfer” functions to this more properly formatted package.
While it uses my earlier code, most of the code in this package is
produced by the LLM and bug fixed by me.
