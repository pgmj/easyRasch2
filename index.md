...
Some of the key functions implemented produce simulation-based critical
values (cutoffs) for conditional item infit MSQ and Yen’s Q3 residuals
to evaluate local dependencies.

See the References tab on this website for a complete list of functions
and their documentation. A package vignette is forthcoming, hopefully
during spring/summer of 2026.
...
Claude Opus to “transfer” functions to this more properly formatted
package. While Claude uses my earlier code as a starting point, most of
the code in this package is produced by the LLM and bug fixed by me. Any
new functions are more or less entirely created by the LLM, based on
code or papers and instructions.
