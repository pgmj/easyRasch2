...
cutoffs object is provided, accessed with `q3_results$pairs`. The per-pair expected range is reported alongside as
...
Table: Reliability for 9 items, n = 600 respondents. PSI is the WLE-based separation reliability and excludes min/max scoring respondents.
