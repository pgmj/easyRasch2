...
item pairs, conditional on the rest-score. Note that this function evaluates both directions of LD, thus the output is two tables.
...
Table: Partial gamma LD analysis (n = 600 complete cases). Positive gamma indicates positive local dependence between items. Direction 1: rest score = total - Item2.
...
Table: Partial gamma LD analysis (n = 600 complete cases). Positive gamma indicates positive local dependence between items. Direction 2: rest score = total - Item1.
