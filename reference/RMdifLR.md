...
The data.frame has one row per item (`level = "item"`) or per item ×
...
attribute / caption come directly from
[`LRtest()`](https://rdrr.io/pkg/eRm/man/LRtest.html)'s return value.
